...
export default class CourseEdit extends Component {
  ...
  getValues() {
    var that = this;
    const getUrl = `${base_url}courses/edit/${this.props.match.params.course_name}/${this.props.match.params.building}/${this.props.match.params.room}/${this.props.match.params.time}`;
    axios.get(getUrl)
  ...
  handleSubmit() {
      ...
      const putUrl = `${base_url}courses/edit/${this.state.pk}`;
