    ...
    return (
      ...
      <div style={{"display": "inline-block"}}>
        ...
        <div style={transcriptStyle}>
         ...
         {this.state.loaded||this.state.audio != null  ? <AudioPlayer audio_url={'http://128.143.67.97:44104/'+this.state.audio.file}></AudioPlayer> : <div>No images to show select page with images</div>}
         </div>
         </div>
      </div>
      </MuiThemeProvider>
